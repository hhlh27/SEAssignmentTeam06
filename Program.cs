...
namespace SEAssignment
{
    public class Program
    {
        ...
        private static void makePayment(List<Voucher> voucherList, Guest id)
        {
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("Payment $" + id.Reservation.ReservationPayment.PaymentDue.ToString("0.00") + " for " + "Guest " + id.Reservation.GuestId + ", " + id.Reservation.Room + ", Check-in: " + id.Reservation.CheckInDate + ", Check-out: " + id.Reservation.CheckOutDate);
